...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _loadFont2.default)([{ family: 'Benton', suffix: 'bold', weight: 600 }, { family: 'Miller', suffix: 'regular', weight: 400 }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addFontRule = function addFontRule(_ref) {
		var font = _ref.font;
		var sheet = _ref.sheet;
		var weight = font.weight;
		var family = font.family;
		var suffix = font.suffix;
	...
	var loadFont = function loadFont(fonts) {
		...
		fonts.forEach(function (font) {
			...
			fontObserver.load(null, timeout).then(function () {
				return addFontRule({ font: font, sheet: sheet });
			}).catch(handleError);
		});
	};
