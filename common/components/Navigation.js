		...
		<nav className={toggleRaceNav} key='nav'>
			<ul className='g-nav__list'>
				...
				<li className='g-nav__item g-nav__item--subnav'>
					<button className='g-nav__link benton-bold icon icon--race' onClick={this.raceOnClick}>Find a race</button>
					<RaceNavigationLinks />
				</li>
				<li className='g-nav__item'>
					<a className='g-nav__link benton-bold icon icon--president' 
