	...
	<nav className='g-nav' key='nav'>
		<ul className='g-nav__list'>
			<li className='g-nav__item'>
				<a className='g-nav__link benton-bold' href='/election'>Elections 2016</a>
			</li>
			<li className='g-nav__item'>
				<a className='g-nav__link benton-bold' href='/town'>Town results</a>
			</li>
			...
			<li className='g-nav__item'>
				<a className='g-nav__link benton-bold' href='/president'>Presidential race</a>
			</li>
		</ul>
	</nav>
)
